...
public class SerializerDeserializerTest {
    ...
    public void testSerializerDeserializer() {
        String outputFileDir = "test/output/" + SerializerDeserializerTest.class.getCanonicalName().replace('.', '/') + "/testSerializerDeserializer/";// +"/test.xml";
        new File(outputFileDir).mkdirs();
        String outputFile = outputFileDir + "test.xml";
